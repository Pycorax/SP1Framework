...
int main()
{
	...
	const size_t NUM_OF_MAPS = 12;
	/*string maps[NUM_OF_MAPS] = {"testing6", "testing2", "testing3","testing4","testing5","testing","testing7","testing8"};*/
	string maps[NUM_OF_MAPS] = {"lol", "lol", "lol", "lol", "lol", "lol", "lol", "lol", "lol", "lol" , "lol" , "testing6"};
